...
class FaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fatura" do
    assert_difference('Fatura.count') do
      post faturas_url, params: { fatura: { descricao: @fatura.descricao, image_data: @fatura.image_data } }
    end
  ...
  test "should update fatura" do
    patch fatura_url(@fatura), params: { fatura: { descricao: @fatura.descricao, image_data: @fatura.image_data } }
