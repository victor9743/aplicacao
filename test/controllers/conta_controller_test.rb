...
class ContaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contum" do
    assert_difference('Contum.count') do
      post conta_url, params: { contum: { descricao: @contum.descricao, image_conta: @contum.image_conta, image_recibo: @contum.image_recibo, valorconta: @contum.valorconta, valorrecibo: @contum.valorrecibo } }
    end
  ...
  test "should update contum" do
    patch contum_url(@contum), params: { contum: { descricao: @contum.descricao, image_conta: @contum.image_conta, image_recibo: @contum.image_recibo, valorconta: @contum.valorconta, valorrecibo: @contum.valorrecibo } }
